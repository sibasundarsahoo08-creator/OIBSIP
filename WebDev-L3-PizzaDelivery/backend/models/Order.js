...
const customPizzaSchema = new mongoose.Schema(
  {
    base: { type: ingredientSelectionSchema, required: true },
    sauce: { type: ingredientSelectionSchema, required: true },
    cheese: { type: ingredientSelectionSchema, required: true },
    vegetables: { type: [ingredientSelectionSchema], default: [] },
  },
  { _id: false }
);
...
const orderItemSchema = new mongoose.Schema(
  {
    ...
    customPizza: { type: customPizzaSchema, default: null },
  },
  { _id: true }
);
...
const orderSchema = new mongoose.Schema(
  {
    ...
    deliveryFee: { type: Number, required: true, min: 0, default: 40 },
